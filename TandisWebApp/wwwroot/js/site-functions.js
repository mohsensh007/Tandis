// ============================
// توابع کمکی سایت (نسخه اصلاح‌شده - نهایی)
// ============================

// جلوگیری از تعریف مجدد توابع
if (typeof window.__SITE_FUNCTIONS_LOADED__ === 'undefined') {
    ...
    function showLoading() {
        // ✅ اول هر لودینگ قبلی رو کامل حذف کن
        hideLoading();
    ...
    function apiCall(url, method, data, onSuccess, onFail) {
        ...
        fetch(url, {
            ...
            .then(async function (response) {
                ...
                // ✅ حتماً hideLoading رو اینجا صدا بزن
                hideLoading();
                if (response.ok) {
            ...
            .catch(function (error) {
                // ✅ حتماً hideLoading رو اینجا هم صدا بزن
                hideLoading();
    ...
    console.log('✅ Site functions loaded (fixed version)');
}